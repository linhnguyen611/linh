			...
			<div id="container" class="grid10 first">
				...
				<div id = "background" class = "grid8">
					...
					<div id = "form" class = "grid7">
						...
						<h1>Admin Login</h1>
						<form id="loginForm" name="loginForm" method="post" action="adminAction.php">
						  <table width="300" border="0" align="center" cellpadding="2" cellspacing="0">
							<tr>
							  <td width="112"><b>Admin Username</b></td>
							...
							<tr>
							  <td><b>User Type</b></td>
							  <td><input name="User_type" type="radio" value="admin" checked="checked" />Admin (admin only)</td>
							  <td></td>
							</tr>
							<tr>
							  <td>&nbsp;</td>
